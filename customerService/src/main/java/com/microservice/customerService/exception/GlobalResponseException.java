...
/*
 * @ControllerAdvice is mainly introduced to overcome the limitations of the @ExceptionHandler annotated: 
 * Handle exceptions globally in our applications.

With @ControllerAdvice, we can create a global handler class with multiple @ExceptionHandler methods to 
...
public class GlobalResponseException  extends ResponseEntityExceptionHandler{
	...
	final Logger logger = LoggerFactory.getLogger(GlobalResponseException.class);
	    ...
	    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
			...
			logger.info("***** inside GlobalResponseException******* invalid JSON method check*****");
		...
		// handleResourceNotFoundException : triggers when there is not resource with the specified ID in Bad
